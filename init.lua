...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'erlang' },
  ...
  },
  {
    ...
    opts = {
      workspaces = {
        {
          name = "personal",
          path = "~/Yandex.Disk/ObsidianVault",
        },
        {
          name = "work",
          path = "~/ecss-local-knowledge-base/ivan_abramovich_vault",
        },
      },
